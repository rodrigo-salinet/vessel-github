...
if (!is_dir(ROOTDIR . '/apucarana-cidade-cancao')) {
    exec('git clone git@git2bis.com.br:bis2bis/bis2bis-stores/apucarana-cidade-cancao.git');
} else {
    echo "LIMPANDO E ATUALIZANDO!" . PHP_EOL;
    exec(
        "cd " . ROOTDIR . "/apucarana-cidade-cancao;" .
        "git reset --hard HEAD;" .
        "git clean -fd;" .
        "git checkout master;" .
        "git fetch;" .
...
exec("cd " . ROOTDIR . "/apucarana-cidade-cancao;git branch -r", $branchs);
echo "========================================= " . PHP_EOL;
