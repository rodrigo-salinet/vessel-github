...
if (!is_dir(ROOTDIR . '/csd-dourados')) {
    exec('git clone git@git2bis.com.br:bis2bis/bis2bis-stores/csd-dourados.git');
} else {
    echo "LIMPANDO E ATUALIZANDO!" . PHP_EOL;
    exec(
        "cd " . ROOTDIR . "/csd-dourados;" .
        "git reset --hard HEAD;" .
        "git clean -fd;" .
        "git checkout master;" .
        "git fetch;" .
...
exec("cd " . ROOTDIR . "/csd-dourados;git branch -r", $branchs);
echo "========================================= " . PHP_EOL;
