...
if (!is_dir(ROOTDIR . '/amigao-csd')) {
    exec('git clone git@git2bis.com.br:bis2bis/bis2bis-stores/amigao-csd.git');
} else {
    echo "LIMPANDO E ATUALIZANDO!" . PHP_EOL;
    exec("cd " . ROOTDIR . "/amigao-csd;" .
        "git reset --hard HEAD;" .
        "git clean -fd;" .
        "git checkout master;" .
        "git fetch;" .
...
exec("cd " . ROOTDIR . "/amigao-csd;git branch -r", $branchs);
echo "========================================= " . PHP_EOL;
